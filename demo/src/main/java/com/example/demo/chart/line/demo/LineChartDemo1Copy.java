...
public class LineChartDemo1Copy extends ApplicationFrame {
    ...
    public LineChartDemo1Copy(String string) {
...
//        "OnBridge11small.png");
    ...
    public static void main(String[] strings) {
        ...
        LineChartDemo1Copy linechartdemo1 = new LineChartDemo1Copy(
